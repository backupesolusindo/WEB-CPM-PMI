<div class="row">
  ...
  <!-- Form Tambah Skill Karyawan (Admin) -->
  <div class="col-md-4">
    <div class="card">
      <div class="card-header blue-gradient white-text">
        Tambah Skill Karyawan
      </div>
      <div class="card-body">
        <form action="<?php echo base_url(); ?>SkillInventory/simpan_skill_karyawan" method="post">
    ...
    <div class="mt-3">
      <a href="<?php echo base_url(); ?>SkillInventory" class="btn btn-secondary btn-block">
        <i class="fas fa-arrow-left"></i> Kembali ke Master Skill
      </a>
    </div>
  </div>

  <!-- Tabel Data Skill Karyawan -->
  <div class="col-md-8">
    <div class="card card-cascade narrower z-depth-1">

      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <h3 class="white-text mx-3">DATA SKILL KARYAWAN</h3>
      </div>
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped" id="myTable">
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo $no++; ?></td>
                <td><?php echo $row->nama_pegawai ? $row->nama_pegawai : $row->id_karyawan; ?></td>
                ...
                <td>
                  <a href="<?php echo base_url(); ?>SkillInventory/hapus_skill_karyawan/<?php echo $row->id_skill_karyawan; ?>"
