...
foreach ($data as $value): ?>
  <tr>
    ...
    <td>
      <a href="<?php echo base_url() ?>Lembur/Presensi/<?php echo $value->idlembur; ?>" class="btn-floating btn-sm btn-success" data-toggle="tooltip" data-placement="top" data-original-title="PRESENSI"><i class="fas fa-check"></i></a>
