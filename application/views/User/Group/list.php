...
<?php echo form_open('GroupRole/delete');?>

<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header text-center">
        <h4>LIST Group Role</h4>
      </div>
      <div class="card-body">
        <a href="<?php base_url(); ?>GroupRole/input" class="float-right">
        ...
        <div class="table-responsive">
          <table id="myTable" class="table color-table info-table tab ">
              ...
              <tbody>
                <?php $no = 1; foreach ($group as $data):
                  $id_check = $data->idgroup_roles;?>
                  <tr>
                      ...
                      <td><?php echo $data->idgroup_roles; ?></td>
