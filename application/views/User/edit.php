          ...
          <div class="card">
            ...
            <div class="card-body card-block">
              ...
              <div class="row form-group">
                ...
                <div class="col-5">
                    <input type="password" name="password" id="password" class="form-control" placeholder="password" value="polije" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-5 ">
                    <input type="password" name="repassword" id="repassword" class="form-control" placeholder="re-password" value="polije" required>
                </div>
                <div class="col-4">
