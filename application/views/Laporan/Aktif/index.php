  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header text-center">
        <h4>Laporan Pegawai Aktif Presensi</h4>
      </div>
      <div class="card-body row">
        ...
        <div class="col-12">
          <div class="table-responsive">
            <table class="display nowrap table table-hover table-striped table-bordered print-view">
              <thead>
                <tr>
                  <th>NO</th>
                  <th>NIP</th>
              ...
              <tbody>
                  <?php $no = 1; foreach ($pegawai as $value):
                    $jml = $this->ModelLaporan->PresensiAktif($value->uuid);
                    ?>
                    <?php if ($jml->num_rows() > 0): ?>
                      <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $value->NIP; ?></td>
                        <td><?php echo $value->nama_pegawai; ?></td>
                        <td><?php echo date("d-m-Y", strtotime($jml->row_array()['waktu'])); ?></td>
                      </tr>
                    <?php endif; ?>
                  <?php endforeach; ?>
              </tbody>
