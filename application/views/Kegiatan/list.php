  ...
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        ...
        <h3 class="white-text mx-3">Jadwal Kegiatan <?php echo $_SESSION['jabatan'] ?></h3>
        <div>
          <a href="<?php base_url(); ?>Kegiatan/input" class="float-right">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-5">
            <label>Unit :</label>
            <select id="unit" class="form-control select2 col-md-12" onchange="sub_unit()">
              <?php if ($_SESSION['jabatan'] == "admin_unit"): ?>
...
<script type="text/javascript">
  ...
  function search() {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url();?>Kegiatan/data_kegiatan",
